...
const PLANS = [
  {
    ...
    items: ['Digital process', 'Avtalsunderlag', 'Dokumenthantering', 'Tidsstämplad köphistorik', 'Tillträdesguide'],
    cta: 'Starta',
    to: '/genomfor-affaren',
  },
  {
    ...
    popular: true,
    items: ['Bostadsannons', 'AI-annonsverktyg', 'Visningsbokning', 'Intressenthantering', 'Köpförfrågningar till fast pris', 'Köparverifiering', 'Avtalsflöde', 'Dokumenthantering', 'Tillträde'],
    cta: 'Sälj din bostad',
    to: '/salj/start',
  },
  {
