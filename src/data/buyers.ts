...
export const BUYER_BANK: BankBuyer[] = [
  b(1843, ['Södermalm'], 5.0 * M, 3, 65, ['balkong', 'hiss'], [['kollektivtrafik', 'high'], ['stadsliv', 'high']]),
  b(1901, ['Södermalm', 'Vasastan'], 5.5 * M, 3, 70, ['balkong'], [['ljus', 'high'], ['oppen-planlosning', 'nice']]),
  b(1777, ['Södermalm'], 4.8 * M, 2, 60, ['hiss'], [['kollektivtrafik', 'high'], ['renoverat', 'nice']]),
  b(2004, ['Södermalm', 'Kungsholmen'], 6.0 * M, 3, 70, [], [['stadsliv', 'high'], ['ljus', 'high'], ['parkering', 'nice']]),
  b(1650, ['Södermalm'], 5.2 * M, 3, 72, ['balkong'], [['kollektivtrafik', 'high'], ['oppen-planlosning', 'high']]),
  b(2110, ['Södermalm', 'Hammarby Sjöstad'], 5.8 * M, 3, 65, ['tvattmaskin'], [['renoverat', 'high'], ['ljus', 'nice']]),
  b(1932, ['Södermalm'], 4.9 * M, 3, 75, ['balkong', 'hiss'], [['kollektivtrafik', 'high'], ['stadsliv', 'nice'], ['lag-avgift', 'nice']]),
  b(1588, ['Södermalm', 'Vasastan', 'Kungsholmen'], 5.5 * M, 2, 55, [], [['stadsliv', 'high'], ['ljus', 'nice']]),
  b(1522, ['Södermalm'], 4.8 * M, 3, 70, ['balkong'], [['kollektivtrafik', 'high'], ['natur', 'high']]),
  b(2201, 'all', 5.5 * M, 3, 65, ['hiss'], [['kollektivtrafik', 'high'], ['natur', 'nice']]),
  b(1455, 'all', 4.6 * M, 3, 70, [], [['ljus', 'high'], ['oppen-planlosning', 'nice'], ['lugnt', 'nice']]),
  b(2330, ['Aspudden', 'Södermalm'], 5.0 * M, 3, 65, ['balkong'], [['natur', 'high'], ['lugnt', 'high'], ['kollektivtrafik', 'nice']]),
  b(1301, 'all', 5.0 * M, 3, 65, ['balkong'], [['natur', 'high'], ['lugnt', 'high'], ['barnvanligt', 'nice']]),
  b(1420, 'all', 4.6 * M, 2, 60, [], [['natur', 'high'], ['parkering', 'nice']]),
  b(1508, 'all', 6.5 * M, 3, 70, [], [['lugnt', 'high'], ['barnvanligt', 'high'], ['parkering', 'high']]),
  b(1614, 'all', 5.5 * M, 3, 65, ['hiss'], [['nyproduktion', 'high'], ['natur', 'nice']]),
  b(1709, 'all', 4.7 * M, 2, 55, [], [['lugnt', 'high'], ['natur', 'high']]),
  b(1822, 'all', 5.2 * M, 3, 72, [], [['barnvanligt', 'high'], ['parkering', 'nice']]),
  b(1967, 'all', 6.0 * M, 3, 70, ['balkong'], [['natur', 'high'], ['stor-balkong', 'high']]),
  b(2045, 'all', 4.9 * M, 3, 65, [], [['nyproduktion', 'high'], ['parkering', 'high']]),
  b(2089, 'all', 5.4 * M, 2, 60, [], [['lugnt', 'high'], ['barnvanligt', 'nice'], ['natur', 'nice']]),
  b(2150, 'all', 4.6 * M, 3, 68, ['hiss'], [['natur', 'high']]),
  b(2266, 'all', 6.2 * M, 3, 75, [], [['parkering', 'high'], ['lugnt', 'nice']]),
  b(2301, 'all', 5.0 * M, 2, 60, ['balkong'], [['barnvanligt', 'high'], ['natur', 'high']]),
  b(2377, 'all', 5.7 * M, 3, 70, [], [['nyproduktion', 'high'], ['lugnt', 'nice']]),
  b(2412, 'all', 4.8 * M, 3, 65, [], [['natur', 'high'], ['parkering', 'high'], ['lugnt', 'nice']]),
  b(2455, 'all', 5.3 * M, 2, 58, ['hiss'], [['lugnt', 'high'], ['stor-balkong', 'nice']]),
  ...
  b(1250, ['Aspudden'], 4.5 * M, 3, 65, ['balkong'], [['natur', 'high']]),
